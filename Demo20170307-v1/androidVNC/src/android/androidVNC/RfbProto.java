...
import android.player.detector.VNCServerOrientationDetector;
...
class RfbProto {
    ...
    public void setOrientationHandler(Handler handler) {
        this.handler = handler;
        VNCServerOrientationDetector.getInstance().setHandler(handler);
        VNCServerOrientationDetector.getInstance().init(host, 5911);
    }

    public void closeCoonection(){
        VNCServerOrientationDetector.getInstance().closeClientSocket();
    }
    ...
    void readConnFailedReason() throws Exception {
        Log.i(TAG, "readConnFailedReason");
    ...
    int negotiateAuthenticationTight() throws Exception {
        Log.i(TAG, "negotiateAuthenticationTight");
    ...
    */
    ...
    void readServerInit() throws IOException {
        ...
        ////////////////////////////
        //重新设置屏幕信息
        framebufferWidth = serverScreenWidth;
        framebufferHeight = serverScreenHeight;



        Log.d("framebufferHeight","framebufferWidth = " + framebufferWidth + "framebufferHeight =" + framebufferHeight);
  ...
  */
    ...
    void setFramebufferSize(int width, int height) {
        Log.i(TAG, "setFramebufferSize width:" + width + ", height:" + height);
    ...
    int readServerMessageType() throws IOException {
        Log.i(TAG, "readServerMessageType");
	...
	*/
    ...
    void readFramebufferUpdate() throws IOException {
        Log.i(TAG, "readFramebufferUpdate");
        is.readByte();
	...
	*/
    ...
    void readFramebufferUpdateRectHdr() throws Exception {
        Log.i(TAG, "readFramebufferUpdateRectHdr");
	...
	*/
    ...
    synchronized void writeFramebufferUpdateRequest(int x, int y, int w, int h,
                                                    boolean incremental)
            throws IOException {
        Log.i(TAG, "writeFramebufferUpdateRequest");
    ...
    public void setServerScreenSie(int serverScreenWidth, int serverScreenHeight) {
        this.serverScreenWidth = serverScreenWidth;
        this.serverScreenHeight = serverScreenHeight;
    ...
    public void setIsLGPhone(boolean phoneModel) {
        this.isLGPhone = phoneModel;
    }
}
