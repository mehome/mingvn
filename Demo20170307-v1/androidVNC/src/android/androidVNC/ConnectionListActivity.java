...
public class ConnectionListActivity extends ListActivity {
	...
	/* (non-Javadoc)
	 * @see android.org.libsdl.app.ListActivity#onListItemClick(android.widget.ListView, android.view.View, int, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.org.libsdl.app.Activity#onDestroy()
	 */
	@Override
